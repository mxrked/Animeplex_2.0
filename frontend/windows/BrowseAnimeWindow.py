'''
    ...
    This is the Browse Anime Window
...
from backend.database.connection_class import db_connection

import sys, pyodbc, atexit



class BrowseAnimeWindow(QMainWindow):


    def __init__(self):
        super(BrowseAnimeWindow, self).__init__()

        uic.loadUi("frontend/ui/BrowseAnimeWindow.ui", self)
